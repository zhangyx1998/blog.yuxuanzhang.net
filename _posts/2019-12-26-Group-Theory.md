...
7. **直积群**
    ...
    $$G_a\otimes G_b = \{E,X_i,\dots,Y_j,\dots,X_iY_j,\dots,X_aY_b\}$$

    $$X_i\in G_a,~Y_j\in G_b$$
...
1. **群的矩阵表示**<span id="群的矩阵表示"></span>
    ...
    <span id="可约表示"></span><span id="不可约表示"></span>
    + 可约表示
        ...
        > 
        > $$ D(A)D(B) = \left[\begin{array}{cc}D^1(A)D^1(B)&0\\0&D^2(A)D^2(B)\\\end{array}\right]$$
        > 
        > 我们将上述拼接矩阵称为 `块状对角矩阵` .
        > 
